...
<Update label="23rd September 2026">

**Catalog:** [9.4.0](https://github.com/moengage/android-dependency-catalog/releases/tag/catalog-v9.4.0) &nbsp;·&nbsp; **BOM:** [4.4.0](https://github.com/moengage/android-dependency-catalog/releases/tag/bom-v4.4.0)

<Warning>
  This release drops support for push token registration and adds support for Firebase Installation ID. In case you are using MoEngage to register for push, before you upgrade, move to Firebase dependency **25.1.2** or above and complete the Firebase Installation ID integration. See [Migrating to Firebase Installation ID](/developer-guide/android-sdk/migration/migrating-to-firebase-installation-id).
</Warning>

<CardGroup cols={2}>
  <Card title="Modules">

    - <span style={{ color: '#008767', fontWeight: 'bold' }}>moe-android-sdk 15.03.00</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>cards-ui-compose 1.0.0</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>geofence 6.1.0</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>pushkit 7.2.0</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>inapp 11.2.2</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>richNotification 7.1.1</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>cards-core 4.0.2</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>cards-ui 4.1.1</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>realtime-trigger 5.0.1</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>inbox 5.0.1</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>inbox-ui 5.0.1</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>personalization 2.1.1</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>security 5.0.1</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>encryptedStorage 4.0.1</span>
...
* **Push registration now uses the Firebase Installation ID:** From 15.03.00, the SDK registers devices for push using the Firebase Installation ID instead of the FCM token.

  * If the SDK handles push registration for your application, update `com.google.firebase:firebase-messaging` to **25.1.2** or higher and add the `firebase_messaging_installation_id_enabled` metadata to your application manifest file. If either step is missing, your application stops receiving push notifications. See [Case 1: The MoEngage SDK Registers the Token](/developer-guide/android-sdk/migration/migrating-to-firebase-installation-id#case-1-the-moengage-sdk-registers-the-token).
  * If your application passes the token itself, push keeps working. The MoEngage token APIs are deprecated and will be removed in a future release. See [Case 2: Your Application Registers the Token](/developer-guide/android-sdk/migration/migrating-to-firebase-installation-id#case-2-your-application-registers-the-token).
...
* Fixed alerting for grouped notifications. The summary notification sometimes alerted instead of the notification that had just arrived. Each notification in a group now alerts on arrival, and the summary notification is silent.

#### Cards UI Compose 1.0.0
...
* **Jetpack Compose support for Cards:** The new `cards-ui-compose` module lets you embed Cards directly in a Jetpack Compose user interface, without wrapping `CardActivity` or `CardFragment` in an interoperability layer. The View-based components remain supported. See [Cards in Jetpack Compose](/developer-guide/android-sdk/cards/cards-ui-compose).
...
* Updated for compatibility with Core SDK 15.03.00.

<span style={{ backgroundColor: 'rgba(212, 107, 8, 0.1)', color: '#D46B08', border: '1px solid #FFE58F', padding: '2px 10px', borderRadius: '12px', fontSize: '0.85em', fontWeight: 'bold' }}>Fixes</span>

* Fixed an issue where cards showed unexpected colors on Android 10 and above when the device's Force Dark setting was on. Cards now always use the colors you configure, in both light and dark mode.
...
* Fixed bottom nudges being obscured by the navigation bar. Nudges anchored to the bottom of the screen with taller content could extend under the system navigation or gesture bar, cutting off text and making the call-to-action hard to tap. Nudges now lay out above the system insets on all devices.

#### Rich Notification 7.1.1
<span style={{ backgroundColor: 'rgba(0, 135, 103, 0.1)', color: '#008767', border: '1px solid #B5F5EC', padding: '2px 10px', borderRadius: '12px', fontSize: '0.85em', fontWeight: 'bold' }}>Improvements</span>

* Updated for compatibility with Core SDK 15.03.00.

#### Realtime Trigger 5.0.1
<span style={{ backgroundColor: 'rgba(0, 135, 103, 0.1)', color: '#008767', border: '1px solid #B5F5EC', padding: '2px 10px', borderRadius: '12px', fontSize: '0.85em', fontWeight: 'bold' }}>Improvements</span>
