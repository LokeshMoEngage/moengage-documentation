...
|---|---|---|---|
| messages | Required | Array | An array of objects having messages to be sent, which can be a bulk or a single object. The maximum limit is 50 messages. |
...
| height | Optional | String | This field denotes the media height. Supported values are: SHORT, MEDIUM, TALL. **Note:** This field is optional only in case of vertical orientation. |
...
| height | Required | String | This field denotes the height of the carousel. |
...
| Key | Optional/Required | Data Type | Description |
|---|---|---|---|
| country_code | Required | String | This field denotes the country calling code for the dial phone suggestion, including the `+` prefix (e.g., `+91`). |
| number | Required | String | This field denotes the phone number for dial phone suggestions, without the country code. |
