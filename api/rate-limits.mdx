...
| `PATCH /v3/custom-segments/{id}` — Update Filter Segment | 50 per minute, 200 per hour, 1,000 per day |
| `PATCH /v2/custom-segments/archive` — Archive Segment | 50 per minute, 200 per hour, 1,000 per day |
| `PATCH /v2/custom-segments/unarchive` — Unarchive Segment | 50 per minute, 200 per hour, 1,000 per day |
