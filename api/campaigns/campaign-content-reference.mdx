...
| `link_branding_domain` | string | Create Campaign only. The custom domain used to brand links in the email body, in place of the standard MoEngage domain. Shown as **Link branding** in the dashboard. Defaults to the workspace setting. |
| `deep_link_domain` | string | Create Campaign only. The deep linking domain used to wrap deep links in the email body. |
