...
<Info>
  Adding a Product Set row requires Recommendations to be set up for your account. Connect an [Item Catalog](/user-guide/content/recommendations/getting-started/catalogs) and [map your user action events](/user-guide/content/recommendations/getting-started/map-user-actions-settings), then create a [Basic or Advanced recommendation](/user-guide/content/recommendations/getting-started/overview#next-steps). For the steps to add a recommendation to an email, see [Using Recommendations in Email](/user-guide/content/recommendations/personalize-campaign-with-recommendations/using-recommendations-in-email).
</Info>
