...
| --- | --- | --- | --- |
| Push | 100K | 60k | 500K for all campaign types. This is a suggested maximum based on the default FCM behaviour. If FCM has allocated a higher limit, you can set a value above 500K. |
