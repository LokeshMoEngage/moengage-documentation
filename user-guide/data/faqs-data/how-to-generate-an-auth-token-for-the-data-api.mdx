...
1. **Input required**:
   ...
   - **API key**
   To find the Workspace ID and API key, go to **Settings** \> **APIs** in the MoEngage dashboard. For creating and managing keys, see [API Key Dashboard](/user-guide/settings/account/api-and-api-keys/api-key-dashboard).
