...
The MoEngage MCP server is available as a **custom connector** for any MCP-compatible client. It is also published in Anthropic's Claude connector directory, so you can add it directly from Claude (web, mobile, Claude API, Claude Code, and Claude Desktop) without entering the server URL yourself. We are actively working to list it on the ChatGPT marketplace as well.
...
<Steps>
  ...
  <Step title="Complete workspace authentication">
    ...
    <div style={{ maxWidth:"440px" }}>
      <Frame>
        <img src="/images/MCP-request-access.png" alt="MoEngage MCP OAuth authorization screen showing account, workspace, role, and data center" />
      </Frame>
    </div>
  </Step>
</Steps>
