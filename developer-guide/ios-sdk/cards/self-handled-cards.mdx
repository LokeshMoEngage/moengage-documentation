...
Each UI element in a card is a [_MoEngageCardWidget_](https://moengage.github.io/ios-api-reference/Classes/MoEngageCardWidget.html) with an identifier that you pass to the click-tracking API. The table below maps the widget identifiers to the elements they represent.

### Basic Card/Illustration Card

| Widget Id | Widget Type                            | Widget Information                |
| --------- | -------------------------------------- | --------------------------------- |
| 0         | Image (MoEngageCardWidgetType.image)   | Image widget in the card.         |
| 1         | Text (MoEngageCardWidgetType.text)     | Header text for the card.         |
| 2         | Text (MoEngageCardWidgetType.text)     | Message text for the card.        |
| 3         | Button (MoEngageCardWidgetType.button) | Call to action(CTA) for the card. |
