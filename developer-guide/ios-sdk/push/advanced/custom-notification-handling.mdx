...
<Warning>
  `MoEngageSDKMessaging.disableBadgeReset(_:)` is deprecated from iOS SDK [10.13.0](/release-notes/sdks/ios#25th-may-2026) and has no effect. Remove any calls to it and use the `Info.plist` key instead.
</Warning>
