...
<Info>
  If your application builds its user interface in Jetpack Compose, use the `cards-ui-compose` module instead of the Activity or Fragment described below. Refer to [Cards in Jetpack Compose](/developer-guide/android-sdk/cards/cards-ui-compose).
</Info>
